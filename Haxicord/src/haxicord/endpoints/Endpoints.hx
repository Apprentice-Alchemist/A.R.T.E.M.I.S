...
import haxicord.types.structs.MessageStruct.Reaction;
import haxicord.types.structs.GuildChannel.Overwrite;
import haxicord.types.structs.Invite;
import haxicord.types.structs.AuditLog.AuditLog;
import haxicord.types.structs.Voice.VoiceRegion;
import haxicord.types.structs.GuildIntegration;
import haxicord.types.structs.GuildEmbed;
import haxicord.types.structs.Connection;
import haxicord.types.structs.Webhook;
import haxicord.types.structs.Emoji;
...
class Endpoints{
    ...
    public function getChannelPins(channel_id:String, cb:Array<Message>->ErrorReport->Void = null) {
        ...
        callEndpoint("GET", endpoint, function(r:Array<haxicord.types.structs.MessageStruct>, e) {
            if(cb == null)return;
            if(e != null)cb(null, e);
            else{
...
//GUILD START
    ...
    public function getChannels(guild_id:String, cb:Array<Channel>->ErrorReport->Void = null) {
        var endpoint = new EndpointPath("/guilds/{0}/channels", [guild_id]);
        callEndpoint("GET", endpoint, function(r:Array<haxicord.types.structs.Guild.GuildChannelTypes>, e) {
            if(cb == null)return;
            if(e != null)cb(null, e);
            else{
    ...
    public function moveChannel(guild_id:String, changes:Typedefs.PositionChange, cb:Array<Channel>->String->Void = null) {
        //Requires manage_channels
        var endpoint = new EndpointPath("/guilds/{0}/channels", [guild_id]);
        callEndpoint("PATCH", endpoint, function(r:Array<haxicord.types.structs.Guild.GuildChannelTypes>, e) {
            if(cb == null)return;
            if(e != null)cb(null, e);
            else{
                var channels = [for(c in r) {client._newChannel(c);} ];
    ...
    public function getGuildMembers(guild_id:String, format:Typedefs.ListGuildMember, cb:Array<GuildMember>->String->Void = null) {
        ...
        callEndpoint("GET", endpoint, function(r:Array<haxicord.types.structs.GuildMember>, e) {
            if(cb == null)return;
            if(e != null)cb(null, e);
            else{
    ...
    public function getGuildBans(guild_id:String, cb:Array<User>->ErrorReport->Void = null) {
        ...
        callEndpoint("GET", endpoint, function(r:Array<haxicord.types.structs.User>, e) {
            if(cb == null)return;
            if(e != null)cb(null, e);
            else{
    ...
    public function getGuildRoles(guild_id:String, cb:Array<Role>->ErrorReport->Void = null) {
        ...
        callEndpoint("GET", endpoint, function(res:Array<haxicord.types.structs.Role>, e) {
            if(cb == null)return;
            if(e != null)cb(null, e);
            else{
    ...
    public function moveRole(guild_id:String, changes:Typedefs.PositionChange, cb:Array<Role>->ErrorReport->Void = null) {
        //Requires MANAGE_ROLES
        var endpoint = new EndpointPath("/guilds/{0}/roles", [guild_id]);
        callEndpoint("PATCH", endpoint, function(res:Array<haxicord.types.structs.Role>, e) {
            if(cb == null)return;
            if(e != null)cb(null, e);
            else{
                var roles = [for(r in res) {client.getGuildUnsafe(guild_id)._newRole(r);} ];
...
//USER START
    ...
    public function getGuilds(filter:Typedefs.GetGuildFilter, cb:Array<Guild>->ErrorReport->Void = null) { 
        ...
        callEndpoint("GET", endpoint, function(r:Array<haxicord.types.structs.Guild>, e) {
            if(cb == null) return;
            if(e != null) cb(null, e);
            else{
    ...
    public function getDMChannels(cb:Array<DMChannel>->ErrorReport->Void = null) {
        ...
        callEndpoint("GET", endpoint, function(r:Array<haxicord.types.structs.DMChannel>, e) {
            if(cb == null) return;
            if(e != null) cb(null, e);
            else{
    ...
    public function createDM(data:{recipient_id:String}, cb:DMChannel->ErrorReport->Void = null) {
        var endpoint = new EndpointPath("/users/@me/channels", []);
        callEndpoint("POST", endpoint, function(r:haxicord.types.structs.DMChannel, e) {
            if(cb == null) return;
            if(e != null) cb(null, e);
            else{
