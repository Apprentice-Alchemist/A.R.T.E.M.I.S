...
import haxicord.websocket.WebSocketConnection;
import haxicord.endpoints.Endpoints;

import haxicord.types.structs.MessageStruct;
...
import haxicord.types.structs.Status;
import haxicord.types.structs.Status.Activity;

import haxicord.cachehandler.DataCache;
import haxicord.cachehandler.MemoryCache;

// import haxicord.utils.Timer;
...
//Flowchart
    ...
    function receiveEvent(m) {
        ...
        switch(m.t) {
            ...
            case "GUILD_MEMBERS_CHUNK": 
                var members:Array<haxicord.types.structs.GuildMember> = d.members;
                var g = getGuildUnsafe(d.guild_id);
                for(m in members) {
    ...
    @:dox(hide)
    public function _newMessage(message_struct: haxicord.types.structs.MessageStruct) {
    ...
    @:dox(hide)
    public function _newUser(user_struct: haxicord.types.structs.User) {
    ...
    @:dox(hide)
    public function _newDMChannel(channel_struct: haxicord.types.structs.DMChannel) {
        var id = channel_struct.id; 
    ...
    @:dox(hide)
    public function _newGuild(guild_struct: haxicord.types.structs.Guild) {
     ...
     */
    public dynamic function onReactionAdd(m: Message, u: User, e: haxicord.types.structs.Emoji) {}
    /**
        ...
        @param e - The emoji of the reaction.
     */
    public dynamic function onReactionRemove(m: Message, u: Null<User>, e: haxicord.types.structs.Emoji) {}
    /**
...
private typedef WSReady = {
    ...
    @:optional var user: haxicord.types.structs.User;
    @:optional var shard: Array<Int>;
    @:optional var session_id: String;
    @:optional var relationships: Dynamic;
    @:optional var private_channels: Array<haxicord.types.structs.DMChannel>;
    @:optional var presences: Array<haxicord.types.structs.Presence>;
    @:optional var guilds: Array<haxicord.types.structs.Guild>;
