...
class User {
     ...
     */
    public var presence:haxicord.types.structs.Presence;
    ...
    @:dox(hide)
    public function new(_user:haxicord.types.structs.User, _client:DiscordClient) {
        client = _client;
    ...
    @:dox(hide)
    public function _update(_user:haxicord.types.structs.User) {
