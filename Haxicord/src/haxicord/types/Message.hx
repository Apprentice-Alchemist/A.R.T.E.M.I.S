...
import haxicord.types.structs.MessageStruct.MessageActivity;
import haxicord.types.structs.MessageStruct.MessageApplication;
import haxicord.types.structs.MessageStruct.Attachment;
...
class Message {
    ...
    @:dox(hide)
    public function new(_msg:haxicord.types.structs.MessageStruct, _client:DiscordClient) {
        client = _client;
    ...
    @:dox(hide)
    public function _update(_msg:haxicord.types.structs.MessageStruct) {
        if(_msg.edited_timestamp != null)
            edited_timestamp_str =_msg.edited_timestamp;
     ...
     */
    public function reply(msg:haxicord.endpoints.Typedefs.MessageCreate, cb = null) {
