...
class CategoryChannel extends GuildChannel {
    @:dox(hide)
    public function new(_chan:haxicord.types.structs.GuildChannel, _client) {
        client = _client;
    ...
    @:dox(hide)
    public function _update(_chan:haxicord.types.structs.GuildChannel) {
        if(_chan.name != null)
            name = _chan.name;
    ...
    @:dox(hide)
    public static function fromStruct(_chan:haxicord.types.structs.GuildChannel,_client){
