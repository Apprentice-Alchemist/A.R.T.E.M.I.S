...
class GuildMember {
    ...
    @:dox(hide)
    public function new(_mem:haxicord.types.structs.GuildMember, _guild:Guild, _client:DiscordClient) {
        client = _client;
        guild = _guild;
    ...
    @:dox(hide)
    public function _update(_mem:haxicord.types.structs.GuildMember) {
    ...
    @:dox(hide)
    public function _updatePresence(_pre:haxicord.types.structs.Presence) {
