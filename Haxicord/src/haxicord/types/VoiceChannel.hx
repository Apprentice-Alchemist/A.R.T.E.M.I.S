...
class VoiceChannel extends GuildChannel {
    ...
    @:dox(hide)
    public function new(_chan:haxicord.types.structs.GuildChannel.VoiceChannel, _client:DiscordClient) {
        client = _client;
    ...
    @:dox(hide)
    public function _update(_chan:haxicord.types.structs.GuildChannel.VoiceChannel) {
        if(_chan.name != null) 
            name = _chan.name;
