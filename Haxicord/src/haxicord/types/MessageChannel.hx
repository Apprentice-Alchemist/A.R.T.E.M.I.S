...
interface MessageChannel{
    ...
    */
    ...
    public function sendMessage(
        mesg:haxicord.endpoints.Typedefs.MessageCreate,
    ...
    public function getMessages(
        format:haxicord.endpoints.Typedefs.MessagesRequest=null,
    ...
    public function deleteMessages(
        mids:haxicord.endpoints.Typedefs.MessageBulkDelete,
        cb:Dynamic->String->Void=null
    ):Void;
