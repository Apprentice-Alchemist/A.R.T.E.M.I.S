...
import haxicord.types.structs.Presence;
...
class Guild{
    ...
    @:dox(hide)
    public function new(_guild:haxicord.types.structs.Guild, _client:DiscordClient) {
        client = _client;
    ...
    @:dox(hide)
    public function _update(_guild:haxicord.types.structs.Guild.Update) {
        if(_guild.unavailable != null)
            unavailable = _guild.unavailable;
    ...
    @:dox(hide)
    public function _updateEmojis(e:Array<haxicord.types.structs.Emoji>) {
        emojis = e;
    }
    ...
    @:dox(hide)
    public function _newMember(memberStruct:haxicord.types.structs.GuildMember) {
    ...
    @:dox(hide)
    public function _newRole(roleStruct:haxicord.types.structs.Role) {
